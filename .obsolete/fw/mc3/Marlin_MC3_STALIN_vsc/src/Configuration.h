...
#define STRING_CONFIG_H_AUTHOR "Michael O. Nikonov" // Who made the changes.
...
#define CUSTOM_MENDEL_NAME "MC3_STALIN"

// Define this to set a unique identifier for this printer, (Used by some programs to differentiate between machines)
// You can use an online service to generate a random UUID. (eg http://www.uuidgenerator.net/version4)
#define MACHINE_UUID "3a51239a-e0b4-48a0-a87c-a784f96e74b1"
...
const bool Z_MIN_ENDSTOP_INVERTING = true; // set to true to invert the logic of the endstop. false
...
//    You must specify the X & Y coordinates of all 3 points
  ...
  // Note: this feature occupies 10'206 byte
    ...
    // is used to esimate the plane of the print bed
      ...
      #define ABL_PROBE_PT_1_X 20 //10,70
      #define ABL_PROBE_PT_1_Y 20 //10
      #define ABL_PROBE_PT_2_X 20 //10,70
      #define ABL_PROBE_PT_2_Y 130 //85 (135)
      #define ABL_PROBE_PT_3_X 120 //85 (135)
      #define ABL_PROBE_PT_3_Y 10 // 65 (65)
  ...
  #define Z_PROBE_OFFSET_FROM_EXTRUDER 1.025//0.91 ( 1.15 optimalno)
  ...
  #define Z_RAISE_BETWEEN_PROBINGS 5  //How much the extruder will be raised when traveling from between next probing points. 2 default
...
//
// Расчет
// XYstep_per_mm = (step_count * microsteps)/(belt_step*pulley_teeth)
//
//#define _MC3_MTR_STEPS_CNT            200
//#define _MC3_DRV_MICROSTEPS           32
//#define _MC3_BELT_STEP                2
//#define _MC3_PULLEY_TEETH             20
//
// Zstep_per_mm = (step_count * microsteps)/Z_step_mm
// Для метрической шпильки М5
