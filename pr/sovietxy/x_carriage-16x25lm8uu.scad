...
module x_carriage_h1(lm8uuend_d=12, lgho=1.5) {
    difference() {
        union() {
        ...
        // LM8UU holes
        translate([0, (13+lgho), 10.5]) rotate([0, 90, 0]) cylinder(d=LM8UU_OD, h=LM8UU_HGHT);
        translate([0, ocy-(13+lgho), 10.5]) rotate([0, 90, 0]) cylinder(d=LM8UU_OD, h=LM8UU_HGHT);
        // Linear guides holes
