        ...
        union() {
            difference() {
                ...
                color("Red") {
                    ...
                    // Chain mount
                    translate([8, -11.9, CARTopZBeg+CARTopBaseCZ+3.15]) rotate([0, 90]) cylinder(h=30, d=3.3);
                    translate([8, -18.1, CARTopZBeg+CARTopBaseCZ+21]) rotate([0, 90]) cylinder(h=30, d=4);
